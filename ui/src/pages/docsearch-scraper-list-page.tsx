...
import { DocSearchScraperTable } from '@/components/docsearch-scraper-table'
...
export function DocSearchScraperListPage({ tscluster }: { tscluster: string }) {
...
const labelSelector = `app=${tscluster}-sts`;

  return (
    <DocSearchScraperTable
